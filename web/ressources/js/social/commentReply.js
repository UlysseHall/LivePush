$(function() {
    ...
    function answering(com)
    {
        ...
        var input = "<form class='col-xs-11 col-xs-offset-1 comment-reply-form' method='POST' action='"+ action +"'> <textarea class='form-control' minlength='2' rows='2' placeholder='Commentez' required></textarea> <button type='submit' class='btn btn-success pull-right btn-sm'>Répondre</button> </form>";
